    ...
    return (
        <div className='flex flex-col mb-14 dark:bg-slate-800 bg-slate-100 rounded-3xl animate-slideUp animation-delay-2  md:flex-row md:space-x-10 md:text-left'>
            ...
            <div className=" flex-grow flex-col sm:rounded-b-3xl md:rounded-none md:rounded-r-3xl p-5 md:py-20 dark:bg-slate-700 bg-slate-200">
                <Infos content={"nabilfoughali.dev@gmail.com"} Icone={IoMail} />
                <Infos content={"+212 6 73 89 94 65"} Icone={IoCall} />
                <Infos content={"nfoughal"} Icone={IoLogoGithub} link={'https://github.com/nfoughal'} />
                <Infos content={"nabil foughali"} Icone={IoLogoLinkedin} link={'https://www.linkedin.com/in/nabil-foughali-b690a5310/'} />
            </div>
        </div>
    )
}
