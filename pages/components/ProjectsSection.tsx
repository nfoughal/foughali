    ...
    let projects = [
        {
            ...
            link: "https://github.com/nfoughal/ft_transcendence",
        ...
        },
        {
            ...
            link: "https://github.com/nfoughal/ft_irc",
        },
        {
            name: "Minishell",
            ...
            link: "https://github.com/nfoughal/minishel",
        },
        {
            name: "Inception",
            ...
            link: "https://github.com/nfoughal/inception__",
        }
    ];
    ...
    return (
        <section id='Projects'>
            ...
            <div className="my-20 md:my-12">
                {/* <hr className="w-6 h-1 mx-auto my-4 bg-teal-500 border-0 rounded"></hr> */}
                <h1 className="text-center font-bold text-4xl">
                    More Projects Are on my <a href="https://github.com/nfoughal" target="_blank" className="text-teal-500 underline"> GitHub </a>
                </h1>
            </div>
        </section>
    )
